    ...
    def Solve(self, local_solver):
        ...
        def SolveLocal():
            for cm_loc in self.cmodels_local:
                solution = local_solver.Solve(cm_loc)
                nonlocal total_time
        ...
        ret_val = local_solver.ExtractSolution(self.cmodel)
