...
#flow_dec = dec.SepVarDecomposer(rs_model, cr.CoordinatorGradient(step_rule=cr.gradstep.ConstantStepRule(0.1)))
flow_dec = dec.SepVarDecomposer(rs_model, cr.CoordinatorGradient(step_rule = cr.gradstep.ObjectiveLevelStepRule(0.76, 1.0)))

#solve decomposed
solution_dec = flow_dec.Solve( opt_solver, [opt_solver, opt_solver] )
